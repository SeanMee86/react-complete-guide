...
const user = props => {
  return __jsx("div", {
    ...
    id: "2798819767"
  }, ["div.jsx-2798819767{border:1px solid #eee;box-shadow:0 2px 3px #ccc;padding:20px;text-align:center;}"]));
};
...
const authPage = props => auth_jsx("div", null, auth_jsx("h1", null, "The ", props.appName, " Page"), auth_jsx(User, {
  name: 'Sean',
  age: 33
}));
